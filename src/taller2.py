...
def main_interfaz():
    ...
    # Regla 1
    # Si la cantidad de integrantes es media, con intensidad de sonido fuerte y ritmo medio, ENTONCES el genero es rap
    regla_1 = np.fmin(np.fmin(cantidad_integrantes_medio, cantidad_intensidad_sonido_alta), cantidad_ritmo_medio)
    ...
    if(eleccion == "Si"):
        ...
        # Colores generos Rock, Rap, Blues, Pop
        ...
        # Regla 1
        llenar_datos_grafico(regla1_graficos[0], integrantes_medio_grafico_fill_between, integrantes_medio_grafico_lineax, integrantes_medio_grafico_lineay)
        ...
        # Regla 7
        llenar_datos_grafico(regla7_graficos[0], integrantes_medio_grafico_fill_between, integrantes_medio_grafico_lineax, integrantes_medio_grafico_lineay)
        ...
        llenar_datos_grafico(regla7_graficos[2], ritmo_medio_grafico_fill_between, ritmo_medio_grafico_lineax, ritmo_medio_grafico_lineay)
